...
function HubFooter({ onNavigate }) {
  const { t } = useLanguage();
  return (
    <footer className="relative z-10 flex shrink-0 flex-col items-center gap-[7px] bg-[var(--color-night-soft)] px-6 pt-4 pb-5 font-body text-xs font-light text-white/70 [text-shadow:0_1px_10px_rgba(0,0,0,0.6)]">
